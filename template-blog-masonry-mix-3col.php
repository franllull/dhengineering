<?php
/*
Template Name: Blog - Masonry - MIX - 3 Columns
*/
?>
<?php get_header() ?>
				...
				<div class="section-content">
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="blog-container masonry blog-three-col mixed-mode">
								<?php
									global $ss_prefix;
								...
								<?php if ( $query->have_posts() ) : while (  $query->have_posts() ) :  $query->the_post(); ?>
									...
									<?php get_template_part( 'lib/template-parts/blog-masonry/blog-masonry-mix-3col' ); ?>
