<?php
/*
Template Name: Blog - Masonry - 2 Columns - Sidebar
*/
?>
<?php get_header() ?>
				...
				<div class="section-content">
					<div class="row">
						<div class="col-sm-8">
							...
							<div class="blog-container masonry blog-two-col">
								<?php
									global $ss_prefix;
								...
								<?php if ( $query->have_posts() ) : while (  $query->have_posts() ) :  $query->the_post(); ?>
									...
									<?php get_template_part( 'lib/template-parts/blog-masonry/blog-masonry-3col' ); ?>
