<?php
	$blog_sharing_switch = ot_get_option( 'blog_sharing_switch', 'off' );
	$blog_sharing_buttons = ot_get_option( 'blog_sharing_buttons', '' );
	if( $blog_sharing_switch == "on" ) {
?>
	<div class="social-sharing">
		<ul>
			<?php if ( in_array('facebook', $blog_sharing_buttons) ) { ?>
			...
			<?php } ?>
			<?php if ( in_array('twitter', $blog_sharing_buttons) ) { ?>
			...
			<?php } ?>
			<?php if ( in_array('gplus', $blog_sharing_buttons) ) { ?>
			...
			<?php } ?>
			<?php if ( in_array('reddit', $blog_sharing_buttons) ) { ?>
			...
			<?php } ?>
			<?php if ( in_array('linkedin', $blog_sharing_buttons) ) { ?>
			...
			<?php } ?>
			<?php if (in_array('email', $blog_sharing_buttons) ) { ?>
